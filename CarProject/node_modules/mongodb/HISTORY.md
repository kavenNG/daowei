...
* Harden MessageHandler in Userserver.js to avoid issues where we cannot find a callback for an operation.
...
* Added socketTimeoutMS and connectTimeoutMS to socket options for repl_set.js and Userserver.js
...
* Correctly emit errors from Userserver.js only wrapping errors that are strings
